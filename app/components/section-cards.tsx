...
export function SectionCards() {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="*:data-[slot=card]:from-primary/5 *:data-[slot=card]:to-card dark:*:data-[slot=card]:bg-card grid grid-cols-1 gap-4 px-4 *:data-[slot=card]:bg-linear-to-t *:data-[slot=card]:shadow-xs lg:px-6 md:grid-cols-4">
        <MetricCard
          title="New Signups"
